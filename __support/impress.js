...
( function( document, window ) {
    ...
    var impress = window.impress = function( rootId ) {
        ...
        var get_active=function()
        {
            if(activeStep)
            {
                return activeStep.getAttribute("id");
            }
            return null;
        }
        ...
        var goto = function( el, duration ) {
            ...
            var obj={
                ...
                mozTransform: rotate( target.rotate, true ) + translate( target.translate ),
                transitionDuration: duration + "ms",
                transitionDelay: ( zoomin ? 0 : delay ) + "ms"
            };
            if(target.ease!=undefined)
            {
                canvas.style.transitionTimingFunction=target.ease;
            }
...
( function( document, window ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        //     console.log(Main.eFrameDetails);
