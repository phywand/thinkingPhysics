// {TPPhPhotonsCurlUpLineUpInterferencePID}{800}{650}
...
function draw() {
  ...
  push();
  translate(detectorlocation.x, detectorlocation.y);
  showPhasorMultipleResultant(4, 0.08, [
  ...
  placeTitleBold(
    "Arrange to describe interference: contributions curling up or lining up"
  );
}
