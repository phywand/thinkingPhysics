//NgQuestionsEquateEnergySchema4StepsPID
...
//     step actions
	if (stepsbutton.checked()){
		...
		energy(2);
	pop();
	linkArrowRight(45+250, 130+175+4, 45+54);
	words(" = ", 45+250+36, 130+175+4+4);
	}
...
if (feedbackbutton.checked()){
   ...
   titleBold("Schema for energy questions: Equate energies for a purpose – 4 essential steps");
}
