// {TPTeElaboratedSchemacompareEnergyPossibilityPID}{800}{620}
...
function draw() {
  ...
  placeTitleBold(
    "Compare energies to explore possibilities (elaborated schema for energy descriptions)"
  );
}
