...
## StepHeader{Here comes the physics}

JustSpeak{Energy is energy and a calculated quantity which is conserved, but which can be dissipated}.

## StepHeader{But on the way, decisions}
